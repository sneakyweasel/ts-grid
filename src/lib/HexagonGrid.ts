...
export default class HexagonGrid {
  ...
  joins(edge: Edge): readonly Tile[] {
    ...
    switch (s) {
      case 'NE':
        return [new Tile(q + 1, r - 1), new Tile(q, r)];
      case 'NW':
        return [new Tile(q, r), new Tile(q, r - 1)];
      case 'W':
  ...
  endpoints(edge: Edge): readonly Vertex[] {
    ...
    switch (s) {
      case 'NE':
        return [new Vertex(q + 1, r - 1, 'S'), new Vertex(q, r, 'N')];
      case 'NW':
        return [new Vertex(q, r, 'N'), new Vertex(q, r - 1, 'S')];
      case 'W':
        return [new Vertex(q, r - 1, 'S'), new Vertex(q - 1, r + 1, 'N')];
    }
    return [];
  }
  ...
  touches(vertex: Vertex): readonly Tile[] {
    ...
    switch (s) {
      case 'N':
        return [new Tile(q + 1, r - 1), new Tile(q, r), new Tile(q, r - 1)];
      case 'S':
        return [new Tile(q, r), new Tile(q, r + 1), new Tile(q - 1, r + 1)];
    }
    return [];
  }
